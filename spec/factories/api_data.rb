FactoryBot.define do
  factory :api_data, class:Hash do
    ...
    DateTimes { { "RequestTakenDateTime": "2011/07/02 23:09:38",
    ...
    Excavator{ {  "CompanyName": "John Doe CONSTRUCTION", "Address": "555 Some RD",
                  "City": "SOME PARK",
                  "State": "ZZ",
    ...
    ExcavationInfo { {  "TypeOfWork": "rpr man hole tops",
                        "WorkDoneFor": "gpc",
                        ...
                        Number:06044-254-020\n\n\t\t\tPrevious Request Number:06171-300-030", "DigsiteInfo": {
                        "LookupBy": "MANUAL", "LocationType": "Multiple Address", "Subdivision": "",
                        "AddressInfo": { "State": "ST", "County": "COUNTY", "Place": "PLACE", "Zip": "",
                          "Address": { "AddressNum": [ "Address 1", "Address 2" ] },
                          "Street": {
                            "Prefix": "",
                            "Name": "Trinity",
                            "Type": "Ave",
